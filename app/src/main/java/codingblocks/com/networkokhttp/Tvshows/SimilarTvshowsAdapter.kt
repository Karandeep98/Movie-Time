...
class SimilarTvshowsAdapter( val context: Context, private val arrayList: ArrayList<Similar>)
    : RecyclerView.Adapter<SimilarTvshowsAdapter.GithubViewHolder>() {
    ...
    inner class GithubViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(user: Similar, position: Int) {
