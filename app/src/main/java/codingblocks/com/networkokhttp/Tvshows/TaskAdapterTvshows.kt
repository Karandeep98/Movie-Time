...
import codingblocks.com.networkokhttp.Todo
...
class TaskAdapterTvshows( val context: Context, private val arrayList: ArrayList<Todo>)
    : RecyclerView.Adapter<TaskAdapterTvshows.GithubViewHolder>() {
    ...
    inner class GithubViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(user: Todo, position: Int) {
            ...
            service.overview(arrayList[position].id.toString().toInt()).enqueue(object : Callback<Basicdetails> {
